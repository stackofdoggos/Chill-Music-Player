...
export function Shelf() {
  ...
  return (
    <group>
      ...
      <group position={[lastSlot.x + SLEEVE.thickness / 2 + 0.012, SHELF.shelfY[1] + 0.018, -2.0]}>
        <mesh castShadow>
      ...
      <group position={[1.62, SHELF.shelfY[0] + 0.018 + 0.015, -1.98]}>
        {[0, 1].map((i) => (
      ...
      <Plant position={[1.0, SHELF.shelfY[2] + 0.018 + 0.035, -2.02]} />
    </group>
  )
}
