...
const KEYFRAMES: RawKeyframe[] = [
  ...
  },
  {
    ...
    keyColor: '#ffdcae',
    keyIntensity: 1.7,
    // Every neighbouring keyframe rakes the back-left wall; Day alone aimed at
    // the room origin, so its pool landed on open floor outside every camera
    // station and midday lost all directional shading.
    keyPos: [2.85, 2.7, 1.1],
    keyTarget: [-0.7, 0.45, -1.62],
    fillColor: '#f4ece0',
    fillIntensity: 0.42,
    fillPos: [-2, 1.8, 2.2],
    lampColor: '#ffb070',
