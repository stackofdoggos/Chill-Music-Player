...
| `src/state/postFx.ts` | Dev-tunable post FX defaults (`grain`, `temporalBlend`, `softness`, chromatic aberration). Read by `PostFxEffects`; Leva panel in `PostFxDebug`. Dev handle: `__postFx`. |
